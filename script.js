...
const workDetails = {
  docval: { name: "DocVal", ask: "Tell me more about DocVal", html: `
    ...
    <p>The honest part: real scans are genuinely hard, and 0.42 is published right next to the pretty synthetic number. Cost is tracked beside accuracy — about $0.005 per document — and CI regression gates re-run the eval on every push.</p>
    ...
    <p class="card-links"><a href="/eval-case-study/">Eval case study →</a> · <a href="https://docval-yy4s.onrender.com" target="_blank" rel="noopener">Live demo ↗</a> · <a href="https://github.com/Sero01/docval" target="_blank" rel="noopener">GitHub ↗</a></p>`},
  ...
  tinyrouter: { name: "the Inbox Firewall", ask: "Tell me more about the Inbox Firewall", html: `
    <p class="lead">One question, answered with numbers: <b>how small can a model get before local automation stops being safe?</b></p>
    <p>A ~26M router — about a thousandth the size of a frontier model — turns each inbox message into one line of a closed, typed action DSL. A hand-written validator parses it, never <code>eval</code>; a tier policy decides what may auto-execute; and anything ambiguous, hostile, or malformed escalates instead of acting. The safety boundary lives in the validator and policy, not in the model.</p>
