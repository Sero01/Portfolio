...
const workDetails = {
  ...
  evals: { name: "the eval harness", ask: "Tell me more about the eval harness", html: `
    ...
    <p>Both systems sit on the same evaluation spine — schema validation, then arithmetic checks, then a held-out benchmark the models never train or prompt against. Cost is a first-class metric next to accuracy, and CI refuses a push that regresses either.</p>
